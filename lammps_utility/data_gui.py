...
def launch():
    ...
    root = Toplevel() #Tk() # Establish Tkinter Window
    ...
    def dump():
        ...
        snapshots = dump_reader.Snapshots.from_dump(file_path) # Exports Snapshots from .dump file
        ...
        def decide_property():
            ...
            thermo_reader.plot_data(timesteps, prop_dict[default_property.get()], 
                                    x_label = "Timestep (#)", y_label = default_property.get(), 
                                    write_path = plot_image_path)
